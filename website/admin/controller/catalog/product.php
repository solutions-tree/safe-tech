	...
	protected function getForm() {
		...
		*/
		...
		if (isset($this->request->post['back_image'])) {
			$data['back_image'] = $this->request->post['back_image'];
		} elseif (!empty($product_info)) {
			$data['back_image'] = $product_info['back_image'];
		} else {
			$data['back_image'] = '';
		}
		$this->load->model('tool/image');
		...
		} elseif (!empty($product_info) && is_file(DIR_IMAGE . $product_info['back_image'])) {
			$data['back_thumb'] = $this->model_tool_image->resize($product_info['back_image'], 100, 100);
		} else {
